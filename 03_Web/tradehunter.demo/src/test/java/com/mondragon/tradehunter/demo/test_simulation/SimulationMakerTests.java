...
class SimulationMakerTests {
    ...
    void testCreateThreads() {
        ...
        assertEquals(20000, dowJones.getMin());
        assertEquals(38000, dowJones.getMax());
    ...
    void testCreateSocialThreads() {
        ...
        assertEquals(8.0, socials[0].getMin());
        assertEquals(10.0, socials[0].getMax());

        assertEquals(simulationMaker.getSimulation(), socials[1].getSimulation());
        assertEquals("Birth rate", socials[1].getName());
        assertEquals(7.5, socials[1].getMin());
        assertEquals(11.5, socials[1].getMax());

        assertEquals(simulationMaker.getSimulation(), socials[2].getSimulation());
        assertEquals("Migration rate", socials[2].getName());
        assertEquals(0.0, socials[2].getMin());
        assertEquals(14.0, socials[2].getMax());
    }

    @Test
    void testCreateEconomicThreads() {
        ...
        assertEquals("Unemployment rate", economics[0].getName());
        assertEquals(8.0, economics[0].getMin());
        assertEquals(10.0, economics[0].getMax());

        assertEquals(simulationMaker.getSimulation(), economics[1].getSimulation());
        assertEquals("Employment rate", economics[1].getName());
        assertEquals(8.0, economics[1].getMin());
        assertEquals(10.0, economics[1].getMax());

        assertEquals(simulationMaker.getSimulation(), economics[2].getSimulation());
        assertEquals("Euro", economics[2].getName());
        assertEquals(7.5, economics[2].getMin());
        assertEquals(11.5, economics[2].getMax());

        assertEquals(simulationMaker.getSimulation(), economics[3].getSimulation());
        assertEquals("Inflation rate", economics[3].getName());
        assertEquals(0.0, economics[3].getMin());
        assertEquals(14.0, economics[3].getMax());
        ...
        assertEquals(0.0, economics[4].getMin());
        assertEquals(14.0, economics[4].getMax());
    }
    ...
    void testCreatePoliticalThreads() {
        ...
        assertEquals("Interest rate", politicals[0].getName());
        assertEquals(3.0, politicals[0].getMin());
        assertEquals(9.0, politicals[0].getMax());

        assertEquals(simulationMaker.getSimulation(), politicals[1].getSimulation());
        assertEquals("Tariff rate", politicals[1].getName());
        assertEquals(4.0, politicals[1].getMin());
        assertEquals(21.0, politicals[1].getMax());

        assertEquals(simulationMaker.getSimulation(), politicals[2].getSimulation());
        assertEquals("Public deficit", politicals[2].getName());
        assertEquals(-8.0, politicals[2].getMin());
        assertEquals(0.0, politicals[2].getMax());
    }
