...
public class SimulationController {
    ...
    public SimulationMaker simulationMaker;
    ...
    public SimulationMaker getSimulationMaker() {
        return simulationMaker;
    }
    public void setSimulationMaker(SimulationMaker simulationMaker) {
        this.simulationMaker = simulationMaker;
    }
