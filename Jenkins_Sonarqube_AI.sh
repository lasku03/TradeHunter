...
sonarCommand="/home/unai_laskurain/sonar-scanner-5.0.1.3006-linux/bin/sonar-scanner -Dsonar.projectKey=${projectKey} -Dsonar.sources=. -Dsonar.host.url=${sonarHostUrl} -Dsonar.token=${sonarToken}"
